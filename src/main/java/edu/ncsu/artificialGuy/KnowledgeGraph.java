...
public class KnowledgeGraph {
	...
	private List<String> queryKR(String match, String where, String ret) {
		...
		// query the KR
		String query = match;
                System.out.println("Query Cypher Neo4j");
                System.out.println("MATCH="+match);
                String wordPhuc[] = match.split("-");
                System.out.println("MATCH[0]="+wordPhuc[0]);
                System.out.println("MATCH[1]="+wordPhuc[1]);
                String chuoi=wordPhuc[1];
                String tam[]=chuoi.split(":");
                for (int p=0;p<tam.length;p++) {
                    System.out.println(tam[p]);
                }
                System.out.println("MATCH[2]="+wordPhuc[2]);
                String wordPhucHa[]=wordPhuc[2].split(":");
                for (int ph=0;ph <wordPhucHa.length;ph++) {
                    System.out.println(wordPhucHa[ph]);
                }
